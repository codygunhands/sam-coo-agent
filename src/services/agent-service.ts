...
export class AgentService {
  ...
  private buildSystemPrompt(
    ...
    const agentName = process.env.AI_EMPLOYEE_NAME || 'sam';
    const agentRole = process.env.AI_ROLE || 'COO';
    
    let prompt = `You are ${agentName === 'sam' ? 'Sam' : agentName}, ${agentRole === 'COO' ? 'Chief Operating Officer' : agentRole}.
